<template>
    <div class="relative flex justify-start md:justify-center md:items-end">
        ...
        <div class="flex pt- md:pt-32 lg:pt-40 xl:pt-72 px-4 md:px-6 xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
            <div class="flex flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
                <div class="flex justify-start items-center space-x-4 mr-4">
                    <div class="cursor-pointer w-72">
                        <img src="/progetto-assistenza-logo.png" alt="logo">
                    </div>
                </div>
                <div class="mt-16 xl:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-y-6 sm:gap-y-0 w-full md:w-auto sm:gap-x-20 md:gap-x-20 xl:gap-8">
                    <div class="sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                        <h2 class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white">Contatti</h2>
                        <p class="text-left text-base leading-none text-gray-100">
                            ProgettoAssistenza Srl
                        </p>
                        <p class="text-left text-base leading-none text-gray-100">
                    ...
                    <div class="sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                        <h2 class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white">Indirizzi Utili</h2>
                        <p class="text-left text-base leading-none text-gray-100">
                            info@progetto-assistenza.it
                        </p>
                        <p class="text-left text-base leading-none text-gray-100">
                            franchising@progetto-assistenza.it
                        </p>
                    </div>

                    <div class=" xl:w-72 flex justify-start items-start flex-col space-y-6">
                        <h2 class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white">Certificato ISO 9001:2015</h2>
                        <p class="text-left text-base leading-none text-gray-100">
                            About Us
                        </p>
                    </div>
            ...
            <div class="mt-4 flex xl:justify-between flex-col-reverse items-center w-full ">
                <p class="mt-8 md:mt-8 text-sm leading-none text-white" >2020 The Good Company. All Rights Reserved</p>
                <div class="mt-8 md:mt-8 md:flex-row flex-col flex md:justify-center w-full md:w-auto justify-start items-start space-y-4 md:space-y-0 md:items-center md:space-x-4 xl:space-x-6">
                ...
                <div class="flex mt-8 justify-start md:justify-end items-start w-full md:w-auto md:items-center space-x-6 ">
